                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class= "mx-3">
                                            ...
                                            <Button class="btn btn-warning mx-1" data-bs-toggle="modal" data-bs-target="#editProductModal" >Editar</Button>
                                            <a href="detalleProducto.php?slug=<?php echo htmlspecialchars($product['slug']); ?>" class="btn btn-danger mx-1">Eliminar</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
            ...
            <div class="modal-body">
                <form id="addProductForm">
                    ...
                    <div class="mb-3">
                        <label for="tags" class="form-label">Etiqueta</label>
                        <select class="form-control" id="tagSelect" name="tag" required>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="editProductForm">
                            ...
                            <div class="mb-3">
                                <label for="editBrandId" class="form-label">ID de Marca</label>
                                <input type="number" class="form-control" id="editBrandId" name="brand_id" required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <label for="editCategories" class="form-label">Categoría</label>
                            ...
                            <div class="mb-3">
                                <label for="editTags" class="form-label">Etiqueta</label>
                                <select class="form-control" id="editTagSelect" name="tag" required>
                                    <option value="">Seleccione una etiqueta</option>
                                    <?php
                                        foreach ($tags as $tag) {
                                            echo "<option value='{$tag['id']}'>{$tag['name']}</option>";
