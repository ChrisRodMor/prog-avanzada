        ...
        <div class="navbar-content">
          <ul class="pc-navbar">
            ...
            <li class="pc-item pc-hasmenu">
              ...
              ></a>
              <ul class="pc-submenu">
                <li class="pc-item"><a class="pc-link" href="<?php echo BASE_PATH; ?>products">Product</a></li>
                <li class="pc-item"><a class="pc-link" href="<?php echo BASE_PATH; ?>products/create">Add New Product</a></li>
              </ul>
            </li>
            <li class="pc-item pc-hasmenu">
              <a href="#!" class="pc-link"
