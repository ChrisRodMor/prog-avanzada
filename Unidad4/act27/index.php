...
$globalToken = $authController->getGlobalToken();
...
<body>
                ...
                <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="navbarNav">
                            ...
                            <form class="d-flex ms-auto" method="POST" action="auth">
                            ...
                            <div class="col-md-4">
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mx-3">
                                            <a href="detalleProducto/<?php echo htmlspecialchars($product['slug']); ?>/" class="btn btn-primary mx-1">Detalles</a>
                                            <button class="btn btn-warning mx-1" data-bs-toggle="modal" data-bs-target="#editProductModal<?php echo $product['id']; ?>">Editar</button>
                                            <form id="eliminar-form" method="POST" action="auth" style="display: inline;">
                                                <input type="hidden" name="global_token" value="<?php echo htmlspecialchars($globalToken); ?>">
        ...
        <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="addProductForm" method="POST" action="auth" enctype="multipart/form-data" >
                            <input type="hidden" name="global_token" value="<?php echo htmlspecialchars($globalToken); ?>">
                            <div class="mb-3">
    ...
    <script>
        console.log("Global Token: <?php echo $_SESSION['global_token']; ?>");
